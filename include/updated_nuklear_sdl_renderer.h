...
#if SDL_VERSION < SDL_VERSIONNUM(2, 0, 22)
...
nk_sdl_init(SDL_Window *win, SDL_Renderer *renderer)
{
    ...
    if (strncmp("metal", name, 5) == 0 && SDL_VERSION < SDL_VERSIONNUM(2, 0, 22))
    {
        SDL_LogWarn(
        ...
        case SDL_EVENT_MOUSE_BUTTON_DOWN:
            {
                ...
                switch(evt->button.button)
                {
                    ...
                    case SDL_BUTTON_MMASK: nk_input_button(ctx, NK_BUTTON_MIDDLE, x, y, down); break;
                    case SDL_BUTTON_RMASK:  nk_input_button(ctx, NK_BUTTON_RIGHT, x, y, down); break;
                }
            }
            return 1;
